...
//! - [`PolicyDecision`] - Result of policy evaluation (from `themis-platform-types`)
...
//! are provided by the `themis-platform-types` crate to ensure schema
//! compatibility across the Themis ecosystem.
//!
//! ## Example
//!
//! ```rust
//! use eunomia_core::{PolicyInput, CallerIdentity, PolicyDecision};
//!
